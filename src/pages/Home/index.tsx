...
export function Home() {     
  ...
  function handleCreatorNewCycle(data: NewCycleFormDate) {
    createNewCycle(data)
    reset()
  }
  ...
  return (
    <HomeContainer>
      <form onSubmit={handleSubmit(handleCreatorNewCycle)}>        
        ...
        { activeCycle ? (
          <StopCoutdowmButton onClick={InterruptCurrentCycle} type="button">
            <HandPalm size={24}/>
            Interromper          
          </StopCoutdowmButton>         
        ) : (
